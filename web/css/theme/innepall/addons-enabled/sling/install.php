<?php
    ...
    /* insert a marker of addon */
    $_sql = "INSERT IGNORE INTO ".K_TBL_SETTINGS." (k_key, k_value) VALUES ('sling_version', '".A_SLING_VERSION."');";
    $DB->_query( $_sql );

    /* Table "sling_jobs" */
    $_sql = "CREATE TABLE IF NOT EXISTS `".A_TBL_SLING_JOBS."` (
