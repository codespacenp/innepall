...
<cms:template title='Companies' parent='_hosting_' icon='briefcase' clonable='1'>
    ...
    <cms:editable name='company_2_row' group='top_group' type='row' order='20'>
        ...
        <cms:editable name='featured' label='Featured' desc='Is it featured product?' opt_values='Yes | No' order='30' opt_selected='No' type='radio' class='col-md-2' />
    ...
    <cms:editable name='company_3_row' group='image_group' type='row' order='40'>
        <cms:editable name='logo' label='Logo' type='image' width='1024' height='1024' crop='1' desc='Use square image' quality='92' show_preview='1' preview_height='32' allowed_ext='jpg, jpeg, png, webp' order='10' class='col-md-6' />
        <cms:editable name='screenshot' label='Screenshot' desc='Screenshot of the company website' type='image' width='1920' height='1080' crop='1' quality='92' show_preview='1' preview_height='32' allowed_ext='jpg, jpeg, png, webp' order='20' class='col-md-6' />
    </cms:editable>
    <cms:repeatable name='links' label='Links' stacked_layout='0' order='50'>
        <cms:editable name='type' label='Type' opt_values='Please Select=- | Homepage| Features | Demo | Download | Purchase | Register' order='10' type='dropdown' />
    ...
    <cms:repeatable name='post_faq' label='Frequently Asked Questions' stacked_layout='1' order='60'>
        ...
        <cms:editable name='answer' label='Answer' type='richtext' toolbar='custom' custom_toolbar='bold, italic, underline, strike, -, subscript, superscript | justifyleft, justifycenter, justifyright, justifyblock | numberedlist, bulletedlist, -, outdent, indent, blockquote | cut, pastetext, pastefromword | undo, redo, -, removeformat, -, link, unlink' />
    </cms:repeatable>
    <cms:globals>
    </cms:globals>
</cms:template>
