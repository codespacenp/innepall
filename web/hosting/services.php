...
<cms:template title='Services' parent='_hosting_' icon='tags' clonable='1'>
    ...
    <cms:editable name='relation_group' label='Relations' type='group' order='20' collapsed='0'>
        <cms:editable name='realtion_row' type='row' order='10'>
            <cms:editable name='service_icon' label='Service Icon' desc="Paste the SVG Icon Text" type='textarea'
                order='10' no_xss_check='1' class='col-md-4' />
            <cms:editable name='services_companies' label='Companies' type='relation' masterpage='hosting/companies.php'
                orderby='page_title' order='20' order_dir='asc' advanced_gui='1' show_manage='1' class='col-md-4' />
            <cms:editable name='services_plans' label='Plans' type='reverse_relation' field='plans_services'
                masterpage='hosting/plans.php' orderby='page_title' order='30' order_dir='asc' advanced_gui='1'
                show_manage='1' class='col-md-4' />
        </cms:editable>
    </cms:editable>
</cms:template>
